...
app.use(cors());  // This will allow all routes to accept cross-origin requests
...
export const initHttpsApp = () => {
    return new Promise<{ app: Express; httpsServer: any }>((resolve, reject) => {
